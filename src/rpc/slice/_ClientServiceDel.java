...
public interface _ClientServiceDel extends Ice._ObjectDel
{
    ...
    void charge(int stationID, int batteryID, double currentAmount, double useAmount, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper;

    void discard(int BatteryID, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper;
    ...
    void unregisterDepot(DepotInfo info, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper;

    void setDepot(int stationID, DepotInfo info, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper;
}
