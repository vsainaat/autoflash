...
public interface _ClientServiceOperations
{
    ...
    void charge(int depotID, int batteryID, double currentAmount, double useAmount, Ice.Current __current);

    void discard(int depotID, int BatteryID, Ice.Current __current);
    ...
    void unregisterDepot(int depotID, Ice.Current __current);

    void setDepot(int depotID, DepotInfo info, Ice.Current __current);
}
