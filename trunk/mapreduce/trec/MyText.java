 ...
 * string.
 */
public class MyText extends BinaryComparable implements
		WritableComparable<BinaryComparable> {
	private static final Log LOG = LogFactory.getLog(MyText.class);
	...
	/** Construct from another MyText. */
	public MyText(MyText utf8) {
		set(utf8);
	}
	...
	/** copy a MyText. */
	public void set(MyText other) {
		set(other.getBytes(), 0, other.getLength());
	}

	/**
	 * Set the MyText to range of bytes
	...
	/**
	 * Append a range of bytes to the end of the given MyText
	 * @param utf8 the data to copy from
	...
	/*
	 * Sets the capacity of this MyText object to <em>at least</em>
	 ...
	 * than the current capacity, the MyText object's capacity is
	 * increased to match.
	...
	private void setCapacity(int len, boolean keepData) {
		if (bytes == null || bytes.length < len) {
			...
			if (len> 1000)log.info("new bytes " + len*2);
	...
	/** Skips over one MyText in the input. */
	...
	/** Returns true iff <code>o</code> is a MyText with the same contents.  */
	...
	/** A WritableComparator optimized for MyText keys. */
