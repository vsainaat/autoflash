...
{
    public void
    charge(int stationID, int batteryID, double currentAmount, double useAmount)
    {
        charge(stationID, batteryID, currentAmount, useAmount, null, false);
    }

    public void
    charge(int stationID, int batteryID, double currentAmount, double useAmount, java.util.Map<String, String> __ctx)
    {
    ...
    private void
    charge(int stationID, int batteryID, double currentAmount, double useAmount, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
    ...
    public void
    discard(int BatteryID)
    {
        discard(BatteryID, null, false);
    }

    public void
    discard(int BatteryID, java.util.Map<String, String> __ctx)
    {
        discard(BatteryID, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    discard(int BatteryID, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public void
    setDepot(int stationID, DepotInfo info)
    {
        setDepot(stationID, info, null, false);
    }

    public void
    setDepot(int stationID, DepotInfo info, java.util.Map<String, String> __ctx)
    {
    ...
    @SuppressWarnings("unchecked")
    private void
    setDepot(int stationID, DepotInfo info, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
    ...
    public void
    unregisterDepot(DepotInfo info)
    {
        unregisterDepot(info, null, false);
    }

    public void
    unregisterDepot(DepotInfo info, java.util.Map<String, String> __ctx)
    {
        unregisterDepot(info, __ctx, true);
    }

    @SuppressWarnings("unchecked")
    private void
    unregisterDepot(DepotInfo info, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        ...
        while(true)
        {
            ...
            try
            {
                __delBase = __getDelegate();
                _ClientServiceDel __del = (_ClientServiceDel)__delBase;
                __del.unregisterDepot(info, __ctx);
                return;
            }
            catch(IceInternal.LocalExceptionWrapper __ex)
            {
    ...
    checkedCast(Ice.ObjectPrx __obj)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::rpc::slice::ClientService"))
                {
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::rpc::slice::ClientService", __ctx))
                {
                    ClientServicePrxHelper __h = new ClientServicePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::rpc::slice::ClientService"))
                {
                    ClientServicePrxHelper __h = new ClientServicePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::rpc::slice::ClientService", __ctx))
                {
                    ClientServicePrxHelper __h = new ClientServicePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
