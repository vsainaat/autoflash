...
public interface ClientServicePrx extends Ice.ObjectPrx
{
    ...
    public void charge(int depotID, int batteryID, double currentAmount, double useAmount, java.util.Map<String, String> __ctx);

    public void discard(int depotID, int BatteryID);
    public void discard(int depotID, int BatteryID, java.util.Map<String, String> __ctx);
    ...
    public void unregisterDepot(int depotID, java.util.Map<String, String> __ctx);

    public void setDepot(int depotID, DepotInfo info);
    public void setDepot(int depotID, DepotInfo info, java.util.Map<String, String> __ctx);
}
